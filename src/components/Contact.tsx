...
const socialLinks = [
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/gamika_kj",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/gamikakj",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <ul className={styles.contactList}>
              <li>
                ...
                <div className={styles.contactText}>
                  ...
                  <span className={styles.contactValue}>+94 70 253 2380</span>
                </div>
              </li>
              <li>
                <div className={styles.contactIcon}>
                ...
                <div className={styles.contactText}>
                  ...
                  <a href="mailto:gamikakj@gmail.com" className={styles.contactValue}>gamikakj@gmail.com</a>
                </div>
              </li>
              <li>
                <div className={styles.contactIcon}>
                ...
                <div className={styles.contactText}>
                  ...
                  <a href="https://www.gamikakj.dev" target="_blank" rel="noopener noreferrer" className={styles.contactValue}>www.gamikakj.dev</a>
                </div>
              </li>
              <li>
                <div className={styles.contactIcon}>
                ...
                <div className={styles.contactText}>
                  ...
                  <span className={styles.contactValue}>Wijayasiri, Dela, Ratnapura</span>
                </div>
              </li>
            </ul>
